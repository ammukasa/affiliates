...
const ELEMENT_DATA: PeriodicElement[] = [
  {position: "LinuxVPS1", name: '1',ram:'2GB', storage: '30GB', symbol: '$6.00/Month',os:'',link:'https://www.interserver.net/vps/'},
  {position: "LinuxVPS2", name: '2',ram:'4GB', storage: '60GB', symbol: '$12.00/Month',os:'',link:'https://www.interserver.net/vps/'},
  {position: "LinuxVPS3", name: '3', ram:'6GB',storage: '90GB', symbol: '$18.00/Month',os:'',link:'https://www.interserver.net/vps/'},
...
const ELEMENT_DATA2: PeriodicElement[] = [
  {position: "WindowsVPS1", name: '1 Core',ram:'2GB', storage: '30GB', symbol: '$10.00/Month',os:'',link:'https://www.interserver.net/vps/windows-vps.html'},
  {position: "WindowsVPS2", name: '2 Cores',ram:'4GB', storage: '60GB', symbol: '$20.00/Month',os:'',link:'https://www.interserver.net/vps/windows-vps.html'},
  {position: "WindowsVPS3", name: '3 Cores', ram:'6GB',storage: '90GB', symbol: '$30.00/Month',os:'',link:'https://www.interserver.net/vps/windows-vps.html'},
  {position: "WindowsVPS4", name: '4 Cores',ram:'8GB', storage: '120GB', symbol: '$40.00/Month',os:'',link:'https://www.interserver.net/vps/windows-vps.html'},
  {position: "WindowsPS5", name: '5 Cores',ram:'10GB', storage: '150GB', symbol: '$50.00/Month',os:'',link:'https://www.interserver.net/vps/windows-vps.html/'},
  {position: "WindowsVPS6", name: '6 Cores',ram:'12GB', storage: '180GB', symbol: '$60.00/Month',os:'',link:'https://www.interserver.net/vps/windows-vps.html'},
  {position: "WindowsVPS7", name: '7 Cores',ram:'14GB', storage: '210GB', symbol: '$70.00/Month',os:'',link:'https://www.interserver.net/vps/windows-vps.html'},
  {position: "WindowsVPS8", name: '8 Cores',ram:'16GB',storage: '214GB', symbol: '$80.00/Month',os:'',link:'https://www.interserver.net/vps/windows-vps.html'},
...
const ELEMENT_DATA3: PeriodicElement0[] = [
  {position0: "StorageVPS1", name: '1 Core',ram:'2GB', storage: '1TB HHD', symbol: '$6.00/Month',os:'',link:'https://www.interserver.net/vps/storage.html'},
  {position0: "StorageVPS2", name: '2 Cores',ram:'4GB', storage: '2TB HHD', symbol: '$12.00/Month',os:'',link:'https://www.interserver.net/vps/storage.html'},
  {position0: "StorageVPS3", name: '3 Cores', ram:'6GB',storage: '3TB HHD', symbol: '$18.00/Month',os:'',link:'https://www.interserver.net/vps/storage.html'},
...
@Component({
  ...
  templateUrl: "./reviews-interserver.component.html",
  styleUrls: ["./reviews-interserver.component.css"],
  providers: [DatePipe]
})


export class AboutComponentinterserver implements OnInit, AfterViewChecked, ElementRef {
  ...
  getAllProducts() {
    this.api.getInterserver().subscribe({
      next: (res) => {
// console.log(res);
  ...
  handleNotify(eventData: Employee) {
    ...
    if (this.ipaddress == ""){
      alert("You Have No Internet Connectivity");
    }else{
    this.api.GetItemInterserver(this.vontedataid).subscribe(res => {
  ...
  onUpdate(): any {
    this.api.updateIteminterserver(this.vontedataid, this.updateForm.value)
      .subscribe(() => {
      }, (err) => {
        console.log(err);
      });
  ...
  getReviewCount() {
    ...
    this.api.getInterserver().subscribe((response) => {
  ...
  addProduct() {
    if (this.productForm.valid) {
      this.api.AddInterserver(this.productForm.value).subscribe({
        next: (res) => {
  ...
  onSubmit(): any {
    if (this.productForm.valid) {
      this.api.AddInterserver(this.productForm.value)
        .subscribe(() => {
  ...
  getFriends() {
    ...
    this.api.getInterserver()
      .subscribe((response) => {
        this.allUser = response;

        this.allUser.forEach((row: any) => {
          if (row.companyName == "interserver") {
            this.allUser2 = this.allUser.filter(
              (product: { companyName: string }) =>
                product.companyName === "interserver"
            ).length;
