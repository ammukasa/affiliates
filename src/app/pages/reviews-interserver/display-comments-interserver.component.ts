...
@Component({
  ...
  templateUrl: './display-comments-interserver.component.html',
  styleUrls: ['./display-comments-interserver.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DisplayCommentsComponentinterserver implements OnInit, OnChanges {
