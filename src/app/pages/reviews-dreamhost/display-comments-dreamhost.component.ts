...
@Component({
  ...
  templateUrl: './display-comments-dreamhost.component.html',
  styleUrls: ['./display-comments-dreamhost.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DisplayCommentsComponentdreamhost implements OnInit, OnChanges {
