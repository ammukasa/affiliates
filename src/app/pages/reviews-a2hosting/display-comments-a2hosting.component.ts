...
@Component({
  ...
  templateUrl: './display-comments-a2hosting.component.html',
  styleUrls: ['./display-comments-a2hosting.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DisplayCommentsComponenta2hosting implements OnInit, OnChanges {
