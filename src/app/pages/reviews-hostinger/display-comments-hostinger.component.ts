...
@Component({
  ...
  templateUrl: './display-comments-hostinger.component.html',
  styleUrls: ['./display-comments-hostinger.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DisplayCommentsComponenthostinger implements OnInit, OnChanges {
