...
@Component({
  ...
  templateUrl: './display-comments-hostgator.component.html',
  styleUrls: ['./display-comments-hostgator.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DisplayCommentsComponenthostgator implements OnInit, OnChanges {
