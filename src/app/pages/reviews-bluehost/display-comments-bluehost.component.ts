...
@Component({
  ...
  templateUrl: './display-comments-bluehost.component.html',
  styleUrls: ['./display-comments-bluehost.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DisplayCommentsComponentbluehost implements OnInit, OnChanges {
