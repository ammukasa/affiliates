...
@Component({
  ...
  templateUrl: './display-comments-godaddy.component.html',
  styleUrls: ['./display-comments-godaddy.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DisplayCommentsComponentgodaddy implements OnInit, OnChanges {
