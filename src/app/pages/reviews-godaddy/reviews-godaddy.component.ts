import { Component, OnInit, AfterViewChecked, ElementRef, Input, HostListener,ViewEncapsulation  } from "@angular/core";
...
const ELEMENT_DATA11: PeriodicElement[] = [
  ...
  {position: "Web Giant", name: '110 GB', ram:'110',storage: '9 TB', symbol: 'Unlimited',os:'	$31.84/mo',link:'https://hostarmada.com/cloud-ssd-Reseller-hosting/'},
  {position: "Site Nova", name: '200 GB', ram:'200',storage: '12 TB', symbol: 'Unlimited',os:'	$44.59/mo',link:'https://hostarmada.com/cloud-ssd-Reseller-hosting/'},
];
...
const ELEMENT_DATA22: PeriodicElement[] = [
  ...
  {position: "Web Giant", name: '110 GB', ram:'110',storage: '9 TB', symbol: 'Unlimited',os:'	$33.72/mo',link:'https://hostarmada.com/cloud-ssd-Reseller-hosting/'},
  {position: "Site Nova", name: '200 GB', ram:'200',storage: '12 TB', symbol: 'Unlimited',os:'	$47.22/mo',link:'https://hostarmada.com/cloud-ssd-Reseller-hosting/'},
];
...
const ELEMENT_DATA33: PeriodicElement[] = [
  ...
  {position: "Web Giant", name: '110 GB', ram:'110',storage: '9 TB', symbol: 'Unlimited',os:'	$35.59/mo',link:'https://hostarmada.com/cloud-ssd-Reseller-hosting/'},
  {position: "Site Nova", name: '200 GB', ram:'200',storage: '12 TB', symbol: 'Unlimited',os:'	$49.84/mo',link:'https://hostarmada.com/cloud-ssd-Reseller-hosting/'},
];
...
const ELEMENT_DATA44: PeriodicElement[] = [
  ...
  {position: "Web Giant", name: '110 GB', ram:'110',storage: '9 TB', symbol: 'Unlimited',os:'	$37.46/mo',link:'https://hostarmada.com/cloud-ssd-Reseller-hosting/'},
  {position: "Site Nova", name: '200 GB', ram:'200',storage: '12 TB', symbol: 'Unlimited',os:'	$52.46/mo',link:'https://hostarmada.com/cloud-ssd-Reseller-hosting/'},
];

const ELEMENT_DATA: PeriodicElement[] = [
  {position: "Shared Starter", name: '50 GB',ram:'Unlimited',   storage: 'Pre-Installed', symbol: '1',os:'$1.99/mo',link:'https://www.dreamhost.com/hosting/shared/'},
  {position: "Shared Unlimited", name: 'Unlimited',ram:'Unlimited',     storage: 'Pre-Installed', symbol: 'Unlimited',os:'	$2.99/mo',link:'https://www.dreamhost.com/hosting/shared/'},

];

 const Biennially: PeriodicElement[] = [
  {position: "Shared Starter", name: 'Free Domain',ram:'Unlimited',   storage: 'Pre-Installed', symbol: '1',os:'$2.95/mo',link:'https://www.dreamhost.com/hosting/shared/'},
  {position: "Shared Unlimited", name: 'Free Domain',ram:'Unlimited',     storage: 'Pre-Installed', symbol: 'Unlimited',os:'	$2.95/mo',link:'https://www.dreamhost.com/hosting/shared/'},
];

 const Annually: PeriodicElement[] = [
  {position: "Shared Starter", name: 'Free Domain',ram:'Unlimited',   storage: 'Pre-Installed', symbol: '1',os:'$2.59/mo',link:'https://www.dreamhost.com/hosting/shared/'},
  {position: "Shared Unlimited", name: 'Free Domain',ram:'Unlimited',     storage: 'Pre-Installed', symbol: 'Unlimited',os:'	$3.95/mo',link:'https://www.dreamhost.com/hosting/shared/'},
];

 const Monthly: PeriodicElement[] = [
  {position: "VPS Basic", name: '30 GB',ram:'Unlimited',   storage: '1 GB', symbol: 'Unlimited',os:'$15.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
  {position: "VPS Business", name: '60 GB',ram:'Unlimited',     storage: '2 GB', symbol: 'Unlimited',os:'	$30.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
  {position: "VPS Professional", name: '120 GB',ram:'Unlimited',   storage: '8 GB', symbol: 'Unlimited',os:'$60.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
  {position: "VPS Enterprise", name: '240 GB',ram:'Unlimited',     storage: '8 GB', symbol: 'Unlimited',os:'	$120.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
];

const ELEMENT_DATA2: PeriodicElement[] = [
  {position: "VPS Basic", name: '30 GB',ram:'Unlimited',   storage: '1 GB', symbol: 'Unlimited',os:'$13.75/mo',link:'https://www.dreamhost.com/hosting/vps/'},
  {position: "VPS Business", name: '60 GB',ram:'Unlimited',     storage: '2 GB', symbol: 'Unlimited',os:'	$27.50/mo',link:'https://www.dreamhost.com/hosting/vps/'},
  {position: "VPS Professional", name: '120 GB',ram:'Unlimited',   storage: '8 GB', symbol: 'Unlimited',os:'$55.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
  {position: "VPS Enterprise", name: '240 GB',ram:'Unlimited',     storage: '8 GB', symbol: 'Unlimited',os:'	$110.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
];

const ELEMENT_DATA3: PeriodicElement0[] = [
  {position0: "VPS Basic", name: '30 GB',ram:'Unlimited',   storage: '1 GB', symbol: 'Unlimited',os:'$10.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
  {position0: "VPS Business", name: '60 GB',ram:'Unlimited',     storage: '2 GB', symbol: 'Unlimited',os:'	$20.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
  {position0: "VPS Professional", name: '120 GB',ram:'Unlimited',   storage: '8 GB', symbol: 'Unlimited',os:'$20.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
  {position0: "VPS Enterprise", name: '240 GB',ram:'Unlimited',     storage: '8 GB', symbol: 'Unlimited',os:'	$30.00/mo',link:'https://www.dreamhost.com/hosting/vps/'},
];
...
@Component({
  ...
  templateUrl: "./reviews-godaddy.component.html",
  styleUrls: ["./reviews-godaddy.component.css"],
  providers: [DatePipe],
  // encapsulation: ViewEncapsulation.None
})


export class AboutComponentgodaddy implements OnInit, AfterViewChecked, ElementRef {
...
// console.log(res);
  ...
  handleNotify(eventData: Employee) {
    ...
    this.api.GetItemGodaddy(this.vontedataid).subscribe(res => {
  ...
  onUpdate(): any {
    this.api.updateItemgodaddy(this.vontedataid, this.updateForm.value)
      .subscribe(() => {
      }, (err) => {
        console.log(err);
      });
  ...
  getReviewCount() {
    ...
    this.api.getGodaddy().subscribe((response) => {
  ...
  addProduct() {
    if (this.productForm.valid) {
      this.api.AddGodaddy(this.productForm.value).subscribe({
        next: (res) => {
  ...
  onSubmit(): any {
    if (this.productForm.valid) {
      this.api.AddGodaddy(this.productForm.value)
        .subscribe(() => {
