...
@Component({
  ...
  templateUrl: './display-comments-cloudways.component.html',
  styleUrls: ['./display-comments-cloudways.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DisplayCommentsComponentcloudways implements OnInit, OnChanges {
