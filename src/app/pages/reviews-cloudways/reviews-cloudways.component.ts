...
const ELEMENT_DATA: PeriodicElement[] = [
  {position: "Vultr Starter Plan", name: '25 GB',ram:'1 x 1.00GHz', storage: '1 GB', symbol: '$11.00',os:'1 TB',link:'https://www.interserver.net/vps/'},
  {position: "Vultr 2GB Plan", name: '55 GB',ram:'1 x 1.00GHz', storage: '2 GB', symbol: '$23.00',os:'2 TB',link:'https://www.interserver.net/vps/'},
  {position: "Vultr 4GB Plan", name: '80 GB', ram:'2 x 2.00GHz',storage: '4 GB', symbol: '$44.00',os:'3 TB',link:'https://www.interserver.net/vps/'},
  {position: "Vultr 8GB Plan", name: '160 GB',ram:'2 x 2.00GHz', storage: '8 GB', symbol: '$84.00',os:'4 TB',link:'https://www.interserver.net/vps/'},
 
  {position: "Vultr 16GB Plan", name: '320 GB',ram:'6 x 2.00GHz', storage: '16 GB', symbol: '$139.00',os:'5 TB',link:'https://www.interserver.net/vps/'},
  {position: "Vultr 32GB Plan", name: '640 GB',ram:'8 x 2.00GHz', storage: '32 GB', symbol: '$225.00',os:'6 TB',link:'https://www.interserver.net/vps/'},
  {position: "Vultr 64GB Plan", name: '1.25 TB', ram:'16 x 2.00GHz',storage: '64 GB', symbol: '$385.00',os:'10 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean Starter Plan", name: '25 GB',ram:'1 x 1.00GHz', storage: '1 GB', symbol: '$10.00',os:'1 TB',link:'https://www.interserver.net/vps/'},

  {position: "DigitalOcean 2GB Plan", name: '50 GB',ram:'1 x 1.00GHz', storage: '2 GB', symbol: '$22.00',os:'2 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean 4GB Plan", name: '80 GB',ram:'2 x 2.00GHz', storage: '4 GB', symbol: '$42.00',os:'4 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean 8GB Plan", name: '160 GB', ram:'4 x 2.00GHz',storage: '8 GB', symbol: '$80.00',os:'5 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean 16GB Plan", name: '320 GB',ram:'6 x 2.00GHz', storage: '16 GB', symbol: '$135.00',os:'6 TB',link:'https://www.interserver.net/vps/'},

  {position: "DigitalOcean 32GB Plan", name: '640 GB',ram:'8 x 2.00GHz', storage: '32 GB', symbol: '$230.00',os:'7 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean 48GB Plan", name: '960 GB',ram:'12 x 2.00GHz', storage: '48 GB', symbol: '$315.00',os:'8 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean 64GB Plan", name: '1.25 TB', ram:'16 x 2.00GHz',storage: '64 GB', symbol: '$395.00',os:'9 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean 96GB Plan", name: '1.88 TB',ram:'20 x 2.00GHz', storage: '96 GB', symbol: '$555.00',os:'10 TB',link:'https://www.interserver.net/vps/'},

  {position: "DigitalOcean 128GB Plan", name: '2.5 TB',ram:'24 x 2.00GHz', storage: '128 GB', symbol: '$715.00',os:'11 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean 192GB Plan", name: '3.75 TB',ram:'32 x 2.00GHz', storage: '192 GB', symbol: '$1,035.00',os:'12 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean 4GB Plan Premium", name: '80 GB', ram:'1 x 2.00GHz',storage: '4 GB', symbol: '$12.00',os:'4 TB',link:'https://www.interserver.net/vps/'},
  {position: "DigitalOcean 8GB Plan Premium", name: '160 GB',ram:'1 x 2.00GHz', storage: '8 GB', symbol: '$26.00',os:'5 TB',link:'https://www.interserver.net/vps/'},

  {position: "DigitalOcean 16GB Plan Premium", name: '320 GB',ram:'2 x 2.00GHz', storage: '16.01 GB', symbol: '$50.00',os:'6 TB',link:'https://www.interserver.net/vps/'},
  {position: "Vultr High Frequency 1GB", name: '32 GB',ram:'1 x 2.00GHz', storage: '1 GB', symbol: '$13.00',os:'1 TB',link:'https://www.interserver.net/vps/'},
  {position: "Vultr High Frequency 2GB", name: '64 GB', ram:'1 x 2.00GHz',storage: '2 GB', symbol: '$26.00',os:'2 TB',link:'https://www.interserver.net/vps/'},
  {position: "Vultr High Frequency 4GB", name: '2.08 TB',ram:'2 x 2.00GHz', storage: '4 GB', symbol: '$50.00',os:'3 TB',link:'https://www.interserver.net/vps/'},
];
...
const ELEMENT_DATA3: PeriodicElement0[] = [
  {position0: "Vultr Starter Plan", name: '25 GB',ram:'1 x 1.00GHz', storage: '1 GB', symbol: '$11.00',os:'Unlimited',link:'https://www.interserver.net/vps/storage.html'},
  {position0: "Start for free", name: 'Unlimited',ram:'-', storage: '0 GB', symbol: '$0.00',os:'Unlimited',link:'https://www.interserver.net/vps/storage.html'},
...
@Component({
  ...
  templateUrl: "./reviews-cloudways.component.html",
  styleUrls: ["./reviews-cloudways.component.css"],
  providers: [DatePipe]
})

export class AboutComponentcloudways implements OnInit, AfterViewChecked, ElementRef {
  ...
  getAllProducts() {
    this.api.getCloudways().subscribe({
      next: (res) => {
// console.log(res);
  ...
  handleNotify(eventData: Employee) {
    ...
    this.api.GetItemCloudways(this.vontedataid).subscribe(res => {
  ...
  onUpdate(): any {
    this.api.updateItemcloudways(this.vontedataid, this.updateForm.value)
      .subscribe(() => {
      }, (err) => {
        console.log(err);
      });
  ...
  getReviewCount() {
    ...
    this.api.getCloudways().subscribe((response) => {
  ...
  addProduct() {
    if (this.productForm.valid) {
      this.api.AddCloudways(this.productForm.value).subscribe({
        next: (res) => {
  ...
  onSubmit(): any {
    if (this.productForm.valid) {
      this.api.AddCloudways(this.productForm.value)
        .subscribe(() => {
  ...
  getFriends() {
    ...
    this.api.getCloudways()
      .subscribe((response) => {
        this.allUser = response;
        this.allUser.forEach((row: any) => {
          if (row.companyName == "cloudways") {
            this.allUser2 = this.allUser.filter(
              (product: { companyName: string }) =>
                product.companyName === "cloudways"
            ).length;
